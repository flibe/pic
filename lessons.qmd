...
In the second part we started the technical content: the receding horizon principle, nominal MPC and its three main properties (optimality, recursive feasibility, stability), robust, stochastic and probabilistic MPC, centralized versus decentralized MPC, and the MPC pseudo-code.
